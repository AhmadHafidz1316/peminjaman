...
<div class="sidebar">
    ...
    <div class="ob">
        <h1 style ="font-size : 70px ; margin-top : 4rem ; margin-left : 3rem ;">HP</h1>
            <div class="ava">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input name="nomor" class="form-control" type="text" placeholder="input nomor Hp" aria-label="default input example">
        <br><br>
